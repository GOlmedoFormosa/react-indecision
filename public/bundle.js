...
_reactDom2.default.render(_react2.default.createElement(_IndecisionApp2.default, { options: ['Devils den', 'Second District'] }), document.getElementById('app'));
...
var AddOption = function (_React$Component) {
  ...
  _createClass(AddOption, [{
    ...
    value: function handleAddOption(e) {
      ...
      // If was not error I clean the input
      if (!error) {
...
var Options = function Options(props) {
  return _react2.default.createElement(
    ...
    props.options && props.options.length === 0 && _react2.default.createElement(
      'p',
      null,
      'Please add an option to get started!'
    ),
    props.options && props.options.length > 0 && props.options.map(function (option) {
